    ...
    return (
        <div className="col-12 flex flex-column align-items-center">
            <div className="flex w-10">
                ...
                <div className='col-12 lg:col-6 xl:col-4'><Link to='/colusTrainingSimpleAppJson'><div className='card mb-0 flex flex-column align-items-center justify-content-center hover zoom' style={{ height: '10rem' }}><div className='text-900 font-medium text-lg'>ColusTrainingSimpleAppJson</div></div></Link></div>
